...
Septh 12th, 2013 | <ul><li>Change <code>schedule</code> structure, adding a a <code>schedules</code> container</li><li>Move <code>timezone</code> from <code>schedule</code> to the top level of the event</li></ul> |
{#changelog}
